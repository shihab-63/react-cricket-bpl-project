  ...
  return (
    <div className="max-w-7xl my-5 pb-52 mx-auto">
      {purchasedPlayers.length === 0 ? (
        <div className="flex mx-3 md:mx-0 flex-col items-center justify-center my-20 p-10 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-300">
          <img
          ...
          <p className="text-gray-400 mt-3 text-sm text-center md:text-lg">
